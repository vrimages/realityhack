...
public class HeadLockScript2 : MonoBehaviour {
  ...
  public void HardHeadLock(GameObject obj) {
    obj.transform.position = Camera.transform.position + Camera.transform.forward + new Vector3(0f, -0.5f, 0f);
  ...
  public void HeadLock(GameObject obj, float speed) {		
    ...
    Vector3 posTo = Camera.transform.position + Camera.transform.forward + new Vector3(0f, -0.5f, 0f);
