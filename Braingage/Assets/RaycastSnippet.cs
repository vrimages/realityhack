...
public class RaycastSnippet : MonoBehaviour 
{
    ...
    void Update()
    {
        ...
        //Vector3 pos = sphere1.transform.position;
        Vector3 dir = (sphere1.transform.position - sphere2.transform.position).normalized;
        _raycastParams.Direction = camTransform.forward;
       // _raycastParams.Direction = dir;
        ...
        Vector3 tpoint = sphere2.transform.position + dir * 6f;
        //_beam.enabled = (_inputModule.PointerInput == MLInputModuleBehavior.PointerInputType.Controller);
        _beam.SetPosition(0, sphere1.transform.position);
        _beam.SetPosition(1, tpoint);
    }
